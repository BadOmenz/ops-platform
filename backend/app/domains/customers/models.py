...
class Customer(Base):
    ...
    billing_phone: Mapped[str | None] = mapped_column(String(100), nullable=True)
    accounts_payable_email: Mapped[str | None] = mapped_column(String(255), nullable=True)
    accounts_payable_phone: Mapped[str | None] = mapped_column(String(100), nullable=True)
